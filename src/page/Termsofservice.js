        ...
        <div className="main-terms">
          <div className="terms">
            ...
            <div className='container-policy'>
                <p>
                  <h3>GOIPTV Terms and Conditions</h3>
                  GOIPTV provides an online video streaming service which allows clients to browse
                  distinctive offerings of live and on-demand programs. 
                  Consequently, by accessing or using any of the GOIPTV 
            ...
            <div className='container-policy'>
                <p>
                  ...
                  In order to become a member and utilize the GOIPTV services, 
            ...
            <div className='container-policy'>
                <p>
                  ...
                  GOIPTV can’t make any guarantees about the content in these regards. 
            ...
            <div className='container-policy'>
                <p>
                  ...
                  You won’t need to uncover it to any GOIPTV agents. 
            ...
            <div className='container-policy'>
                <p>
                  ...
                  without notice or liability, if GOIPTV determines in its sole discretion that you have breached these Terms, 
                  disregarded any law, rule, or regulation. The GOIPTV logo, and other GOIPTV marks, graphics, scripts, 
                  are trademarks of GOIPTV. None of the GOIPTV trademarks may be copied, downloaded, or otherwise exploited.
                </p>
            </div>
          </div>
        </div>
